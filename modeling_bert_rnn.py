...
# global_step/sec: 2.19
# loss = 9.600961, step = 10000
# 100Wstep, Loss for final step: 5.4803905
...
class BertModel(object):
    ...
    def __init__(self,
        ...
        with tf.variable_scope(scope, default_name="bert"):
            ...
            self.embedding_output = my_lstm_layer(self.embedding_output, is_training=is_training)[2]
            self.embedding_output = tf.cast(tf.expand_dims(input_mask, -1), tf.float32) * self.embedding_output
