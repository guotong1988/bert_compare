...
# global_step/sec: 2.90
# loss = 9.279186, step = 10000
# 100W step, Loss for final step: 5.40
            ...
            with tf.variable_scope("attention"):
                ...
                with tf.variable_scope("self"):
                    ...
                    attention_head = multihead_attention(
                        query_antecedent=layer_input,
                        memory_antecedent=layer_input,
                        bias=attention_mask,
                        total_key_depth=hidden_size,
                        total_value_depth=hidden_size,
